...
namespace MyHW.homework6DataSetTableAdapters {
    ...
    public partial class PhotoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Photo] WHERE (((@IsNull_CityID = 1 AND [CityID] IS NULL) OR ([" +
                "CityID] = @Original_CityID)) AND ([PhotoID] = @Original_PhotoID))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Photo] ([CityID], [Photo]) VALUES (@CityID, @Photo);\r\nSELECT C" +
                "ityID, Photo, PhotoID FROM Photo WHERE (PhotoID = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Photo] SET [CityID] = @CityID, [Photo] = @Photo WHERE (((@IsNull_Ci" +
                "tyID = 1 AND [CityID] IS NULL) OR ([CityID] = @Original_CityID)) AND ([PhotoID] " +
                "= @Original_PhotoID));\r\nSELECT CityID, Photo, PhotoID FROM Photo WHERE (PhotoID " +
                "= @PhotoID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        public virtual homework6DataSet.PhotoDataTable GetDataBy(global::System.Nullable<int> CityID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((CityID.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((int)(CityID.Value));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(global::System.Nullable<int> Original_CityID, int Original_PhotoID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> CityID, byte[] Photo, global::System.Nullable<int> Original_CityID, int Original_PhotoID, int PhotoID) {
            if ((CityID.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> CityID, byte[] Photo, global::System.Nullable<int> Original_CityID, int Original_PhotoID) {
            return this.Update(CityID, Photo, Original_CityID, Original_PhotoID, Original_PhotoID);
        }
    }
