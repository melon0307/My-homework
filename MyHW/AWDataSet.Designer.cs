...
SELECT ProductPhotoID, ThumbNailPhoto, ThumbnailPhotoFileName, LargePhoto, LargePhotoFileName, ModifiedDate FROM Production.ProductPhoto WHERE (ProductPhotoID = @ProductPhotoID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT LargePhoto, LargePhotoFileName, ModifiedDate, ProductPhotoID, ThumbNailPho" +
                "to, ThumbnailPhotoFileName FROM Production.ProductPhoto WHERE (ModifiedDate BETW" +
                "EEN @date1 AND @date2)";
        ...
        public virtual int DateBetween(AWDataSet.ProductPhotoDataTable dataTable, System.DateTime date1, System.DateTime date2) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual AWDataSet.ProductPhotoDataTable GetDataBy1(string yyyy) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((yyyy == null)) {
                throw new global::System.ArgumentNullException("yyyy");
            }
