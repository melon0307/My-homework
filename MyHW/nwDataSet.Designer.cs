...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice" +
                ", UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM dbo.Products where" +
                " UnitPrice between @price1 and @price2";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@price1", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@price2", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int ProductName(nwDataSet.ProductsDataTable dataTable, string productname1) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((productname1 == null)) {
                throw new global::System.ArgumentNullException("productname1");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(productname1));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int UnitPriceBetween(nwDataSet.ProductsDataTable dataTable, global::System.Nullable<decimal> price1, global::System.Nullable<decimal> price2) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((price1.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(price1.Value));
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            if ((price2.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[1].Value = ((decimal)(price2.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual nwDataSet.ProductsDataTable GetDataBy(global::System.Nullable<decimal> price1, global::System.Nullable<decimal> price2) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((price1.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(price1.Value));
            }
